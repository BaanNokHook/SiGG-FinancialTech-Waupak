...
namespace GM.Application.Web.Areas.Report.Controllers
{
    ...
    public class ReportAmendCancelController : BaseController  
    {
         ...
         public ActionResult Index(ReportCriteriaModel reportCriteriaModel, FormCollection collection)  
         {
            try 
            {
                ...
                if collection["Excel"] != null)  
                {
                    ...
                    rowIndex++;  
                    excelRow = sheet.CreateRow(rowIndex);
                    excelTemplate.CreateCellColHead(excelRow, 0, "Title");
                    excelTemplate.CreateCellColHead(excelRow, 1, "Table"); 
                    //Add Summary
                    ...
                    sheet.AddMergeRegion(new CellRangeAddress(18, 18, 0, 0));  
                    sheet.AddMergeRegion(new CellRangeAddress(18, 18, 1, 1));  
                    sheet.AddMergeRegion(new CellRangeAddress(18, 18, 2, 2));  
                    sheet.AddMergeRegion(new CellRangeAddress(18, 18, 3, 3));  
                    sheet.AddMergeRegion(new CellRangeAddress(18, 18, 4, 4));  
                    sheet.AddMergeRegion(new CellRangeAddress(18, 18, 5, 5));   
                    ...
                    Response.AppendHeader("Content-disposition", "attxchment; filename=" + Report_File_Name + ".xls");  
         ...
         {
            var ds = new DataSet();  
            apiReport.ReportData.AmendCancelReport(data, =>  
            {
