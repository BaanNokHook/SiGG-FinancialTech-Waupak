...
namespace iDiTect.Excel.Demo
{
    ...
    public static class ChartHelper 
    {
      public static void AddChart()
      {
            ...
            // Set x-series and y-seriesdata from range of cells    
            ...
            var colChart = worksheet.Drawing .AddChart("chart1", ChartType.ColumnClustered);   
            // Set chart location and size  
            colChart.SetPosition(0, 200);   
            colChart.SetSize(400, 300);   
            //Add series  
            var series1 = colChart.Series.Add.Add(xSeries, ySeries1);  
            ...
            series.Border.Fill.Color = System.Drawing.Color.Green;   
