$(document).ready(function () {
    ...
    GM.RPDealVerify.Form = {};
    GM.RPDealVerify.Form.Search = function () {
        $('#search-form :input').each(function () {
            var input = $(this);
            var key = input[0].name.split('.')[1];
            switch (key) {
                case "repo_deal_type_code": GM.RPDealVerify.Table.columns(3).search($(this).val()); break;
                case "trans_deal_type": GM.RPDealVerify.Table.columns(4).search($(this).val()); break;
                case "trans_type": GM.RPDealVerify.Table.columns(5).search($(this).val()); break;
                case "port": GM.RPDealVerify.Table.columns(6).search($(this).val()); break;
                case "purpose": GM.RPDealVerify.Table.columns(7).search($(this).val()); break;
                case "counter_party_code": GM.RPDealVerify.Table.columns(8).search($(this).val()); break;
                case "maturity_date": GM.RPDealVerify.Table.columns(12).search($(this).val()); break;
                case "cur": GM.RPDealVerify.Table.columns(16).search($(this).val()); break;
                case "from_trans_no": GM.RPDealVerify.Table.columns(20).search($(this).val()); break;
                case "to_trans_no": GM.RPDealVerify.Table.columns(21).search($(this).val()); break;
                case "from_trade_date": GM.RPDealVerify.Table.columns(22).search($(this).val()); break;
                case "to_trade_date": GM.RPDealVerify.Table.columns(23).search($(this).val()); break;
                case "from_settlement_date": GM.RPDealVerify.Table.columns(24).search($(this).val()); break;
                case "to_settlement_date": GM.RPDealVerify.Table.columns(25).search($(this).val()); break;
                case "from_maturity_date": GM.RPDealVerify.Table.columns(26).search($(this).val()); break;
                case "to_maturity_date": GM.RPDealVerify.Table.columns(27).search($(this).val()); break;
                case "user_id": GM.RPDealVerify.Table.columns(28).search($(this).val()); break;
            }
        });

        GM.RPDealVerify.Table.draw();
    };
    GM.RPDealVerify.Form.Initial = function () {
        $("#action-form")[0].reset();
    };
    GM.RPDealVerify.Form.DataBinding = function (p) {
