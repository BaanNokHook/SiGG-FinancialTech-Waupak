...
$(document).ready(function () {
    ...
    //#region : Counter Party Type Code :
    ...
    $("#ul_country_add").on("click", ".searchterm", function (event) {
        ...
        if ($('#country_id').val() != '65') {
            ...
            $("#ddl_province_add").removeAttr("disabled");
    ...
    GM.Counterparty = {};
    GM.Counterparty.Save = function (form) {
        // GM.Counterparty.Payment.AddToForm(form);
    ...
    GM.Counterparty.Payment.Table.RowEmpty = function () {
        var row = $("<tr></tr>");
        var col = $('<td class="long-data text-center empty-data" style="height:50px;" colspan="14"> No data.</td>');
        row.append(col);
    ...
    GM.Counterparty.Payment.Form.Show = function (btn) {
        ...
        switch (action) {
            case 'create':
                ...
                GM.Counterparty.Payment.Form.ButtonSave.removeClass('btn-delete').addClass('btn-primary').text('+ Add Bank List');
            ...
            case 'update':
                ...
                GM.Counterparty.Payment.Form.ButtonSave.removeClass('btn-delete').addClass('btn-primary').text('Save Bank List');
                break;
        ...
        if (IsInValid) {
            switch (action) {
                case 'create':
                    ...
                    var rowindex = GM.Counterparty.Payment.Table.find("tbody tr:last").data("id");
                    //var arrindex = GM.Counterparty.Payment.Table.find("tbody tr:last").length;
                    console.log("create rowindex : " + rowindex);
                    if (!GM.Counterparty.Payment.Table.RowAny(nosto_vosto_code_val, payment_method_val)) {
                        ...
                        if (rowindex !== 0)
                            rowindex = GM.Counterparty.Payment.Table.find("tbody tr").length;

                        var ColAccountType = $('<td class="long-data">' + nosto_vosto_code_text +
                            '<input name="Payment[' + rowindex + '].nosto_vosto_code" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.nosto_vosto_name" textvalue= "' + nosto_vosto_code_text + '"' +
                            'valuefield="PaymentRightModal.nosto_vosto_code" value= "' + nosto_vosto_code_val + '" >' +
                            '<input name="Payment[' + rowindex + '].nosto_vosto_name" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.nosto_vosto_name" textvalue= "' + nosto_vosto_code_text + '"' +
                            'valuefield="PaymentRightModal.nosto_vosto_code" value= "' + nosto_vosto_code_val + '" >' +
                            '</td > ');

                        var ColBankName = $('<td class="long-data">' + bank_name_text +
                            '<input name="Payment[' + rowindex + '].bank_code" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.bank_name" textvalue="' + bank_name_text + '" ' +
                            'valuefield="PaymentRightModal.bank_code" value="' + bank_name_val + '">' +
                            '<input name="Payment[' + rowindex + '].bank_name" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.bank_name" textvalue="' + bank_name_text + '" ' +
                            'valuefield="PaymentRightModal.bank_code" value="' + bank_name_val + '">' +
                            '</td>');
                        ...
                        var ColPaymentMathod = $('<td class="long-data">' + payment_method_text +
                            '<input name="Payment[' + rowindex + '].payment_method" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.payment_method_name" textvalue="' + payment_method_text + '" ' +
                            'valuefield="PaymentRightModal.payment_method" value="' + payment_method_val + '">' +
                            '<input name="Payment[' + rowindex + '].payment_method_name" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.payment_method_name" textvalue="' + payment_method_text + '" ' +
                            'valuefield="PaymentRightModal.payment_method" value="' + payment_method_val + '">' +
                            '</td>');

                        var ColAccountNo = $('<td>' + accountno + '<input name="Payment[' + rowindex + '].account_number" Isdropdown="false" type="hidden" value="' + accountno + '"></td>');
                        var ColCaNo = $('<td>' + cano + '<input name="Payment[' + rowindex + '].ca_no" Isdropdown="false"  type="hidden" value="' + cano + '"></td>');
                        var ColSaNo = $('<td>' + sano + '<input name="Payment[' + rowindex + '].sa_no" Isdropdown="false"  type="hidden" value="' + sano + '"></td>');
                        var ColParticipantID = $('<td>' + participantid + '<input name="Payment[' + rowindex + '].participant_id" Isdropdown="false"  type="hidden" value="' + participantid + '"></td>');
                        ...
                        var ColRowStatus = $('<input name="Payment[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="create">');

                        var ColAction = $('<td class="action" style="min-width: 105px">' +
                            '<button class="btn btn-default btn-round icon-only" type="button" data-id="' + nosto_vosto_code_text + '" data-action="update" onclick="GM.Counterparty.Payment.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + nosto_vosto_code_text + '" data-action="delete" onclick="GM.Counterparty.Payment.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                            '</button>' +
                            '</td>');
                ...
                case 'update':
                    ...
                    if (!GM.Counterparty.Payment.Table.RowAny(nosto_vosto_code_val, payment_method_val, rowindex)) {
                        ...
                        var ColAction = row.children("td:nth-child(14)");
                        ...
                        ColAccountType.html(nosto_vosto_code_text +
                            ...
                            '<input name="Payment[' + rowindex + '].nosto_vosto_name" type="hidden" Isdropdown="true" ' +
                            'textfield="PaymentRightModal.nosto_vosto_name" textvalue="' + nosto_vosto_code_text + '" ' +
                            'valuefield="PaymentRightModal.nosto_vosto_code" value="' + nosto_vosto_code_text + '">');
                        ...
                        ColPaymentMathod.html(payment_method_text +
                            ...
                            'textfield="PaymentRightModal.payment_method_name" textvalue="' + payment_method_text + '" ' +
                            'valuefield="PaymentRightModal.payment_method" value="' + payment_method_val + '">');
                        ColAccountNo.html(accountno + '<input name="Payment[' + rowindex + '].account_number" Isdropdown="false" type="hidden" value="' + accountno + '">');
                        ColCaNo.html(cano + '<input name="Payment[' + rowindex + '].ca_no" Isdropdown="false"  type="hidden" value="' + cano + '">');
                        ColSaNo.html(sano + '<input name="Payment[' + rowindex + '].sa_no" Isdropdown="false"  type="hidden" value="' + sano + '">');
                        ColParticipantID.html(participantid + '<input name="Payment[' + rowindex + '].participant_id" Isdropdown="false"  type="hidden" value="' + participantid + '">');
                        ...
                        ColRowStatus.html('<input name="Payment[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="' + textstatus + '">');

                        ColAction.html('<button class="btn btn-default btn-round icon-only" type="button" data-id="' + bank_name_text + '" data-action="update" onclick="GM.Counterparty.Payment.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + bank_name_text + '" data-action="delete" onclick="GM.Counterparty.Payment.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                            '</button>');
                    }
                ...
                case 'delete':
                    ...
                    if (rowindex === 0) {
                        row = $('<tr></tr>');
                        var rowEmpty = '<td class="long-data text-center empty-data" style="height: 50px; " colspan="14"> No data.</td>';
                        row.append(rowEmpty);
                        GM.Counterparty.Payment.Table.append(row);
    ...
    GM.Counterparty.Identify.Form.Show = function (btn) {
        ...
        switch (action) {
            case 'create':
                ...
                GM.Counterparty.Identify.Form.ButtonSave.removeClass('btn-delete').addClass('btn-primary').text('+ Add Identify');
        ...
        if (isValid) {
            switch (action) {
                case 'create':
                    ...
                    var rowindex = GM.Counterparty.Identify.Table.find("tbody tr:last").data("id");
                    ...
                    if (!GM.Counterparty.Identify.Table.RowAny(unique_val)) {
                        ...
                        if (rowindex !== 0)
                            rowindex = GM.Counterparty.Identify.Table.find("tbody tr").length;

                        var ColUniqueID = $('<td class="long-data">' + unique_text +
                            '<input name="Identify[' + rowindex + '].unique_id" type="hidden" Isdropdown="true" ' +
                            'textfield="IdentifyRightModal.unique_name" textvalue="' + unique_text + '" ' +
                            'valuefield="IdentifyRightModal.unique_id" value="' + unique_val + '">' +
                            '<input name="Identify[' + rowindex + '].unique_name" type="hidden" Isdropdown="true" ' +
                            'textfield="IdentifyRightModal.unique_name" textvalue="' + unique_text + '" ' +
                            'valuefield="IdentifyRightModal.unique_id" value="' + unique_text + '">' +
                            '</td>');

                        var ColIdentifyType = $('<td class="long-data">' + identify_type_text +
                            '<input name="Identify[' + rowindex + '].identify_type" type="hidden" Isdropdown="true" ' +
                            'textfield="IdentifyRightModal.identify_type_text" textvalue="' + identify_type_text + '" ' +
                            'valuefield="IdentifyRightModal.identify_type" value="' + identify_type_val + '">' +
                            '<input name="Identify[' + rowindex + '].identify_type_text" type="hidden" Isdropdown="true" ' +
                            'textfield="IdentifyRightModal.identify_type_text" textvalue="' + identify_type_text + '" ' +
                            'valuefield="IdentifyRightModal.identify_type" value="' + identify_type_text + '">' +
                            '</td>');


                        var ColIdentifyNo = $('<td>' + identify_no + '<input name="Identify[' + rowindex + '].identify_no" Isdropdown="false" type="hidden" value="' + identify_no + '"></td>');
                        var ColJurisRegDate = $('<td>' + juris_reg_date + '<input name="Identify[' + rowindex + '].juris_reg_date" Isdropdown="false"  type="hidden" value="' + juris_reg_date + '"></td>');
                        var ColRegBusEname = $('<td>' + reg_bus_ename + '<input name="Identify[' + rowindex + '].reg_bus_ename" Isdropdown="false"  type="hidden" value="' + reg_bus_ename + '"></td>');
                        var ColRegBustname = $('<td>' + reg_bus_tname + '<input name="Identify[' + rowindex + '].reg_bus_tname" Isdropdown="false"  type="hidden" value="' + reg_bus_tname + '"></td>');

                        var ColRowStatus = $('<td><input name="Identify[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="create"></td>');

                        var ColAction = $('<td class="action">' +
                            '<button class="btn btn-default btn-round icon-only" type="button" data-id="' + unique_text + '" data-action="update" onclick="GM.Counterparty.Identify.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + unique_text + '" data-action="delete" onclick="GM.Counterparty.Identify.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                            '</button>' +
                            '</td>');
                ...
                case 'update':
                    ...
                    if (!GM.Counterparty.Identify.Table.RowAny(unique_val, null, rowindex)) {
                        ...
                        ColIdentifyNo.html(identify_no + '<input name="Identify[' + rowindex + '].identify_no" Isdropdown="false" type="hidden" value="' + identify_no + '">');
                        ColJurisRegDate.html(juris_reg_date + '<input name="Identify[' + rowindex + '].juris_reg_date" Isdropdown="false"  type="hidden" value="' + juris_reg_date + '">');
                        ColRegBusEname.html(reg_bus_ename + '<input name="Identify[' + rowindex + '].reg_bus_ename" Isdropdown="false"  type="hidden" value="' + reg_bus_ename + '">');
                        ColRegBusTname.html(reg_bus_tname + '<input name="Identify[' + rowindex + '].reg_bus_tname" Isdropdown="false"  type="hidden" value="' + reg_bus_tname + '">');

                        ColRowStatus.html('<input name="Identify[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="' + textstatus + '">');

                        ColAction.html('<button class="btn btn-default btn-round icon-only" type="button" data-id="' + unique_text + '" data-action="update" onclick="GM.Counterparty.Identify.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + unique_text + '" data-action="delete" onclick="GM.Counterparty.Identify.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                ...
                case 'delete':
                    ...
                    if (checkrow == 0) {
                        ...
                        row.append(rowEmpty);
                        GM.Counterparty.Identify.Table.append(row);
                        //GM.Counterparty.Identify.Table.attr("style", "display: none");
                    }
    ...
    GM.Counterparty.Rating.Form.Show = function (btn) {
        ...
        switch (action) {
            case 'create':
                ...
                GM.Counterparty.Rating.Form.ButtonSave.removeClass('btn-delete').addClass('btn-primary').text('+ Add Rating');
            ...
            case 'update':
                ...
                GM.Counterparty.Rating.Form.ButtonSave.removeClass('btn-delete').addClass('btn-primary').text('Save Rating');
                break;
        ...
        if (isValid) {
            switch (action) {
                case 'create':
                    ...
                    var rowindex = GM.Counterparty.Rating.Table.find("tbody tr:last").data("id");
                    ...
                    if (!GM.Counterparty.Rating.Table.RowAny(agency_val)) {
                        ...
                        if (rowindex !== 0)
                            rowindex = GM.Counterparty.Rating.Table.find("tbody tr").length;

                        var ColAgencyCode = $('<td class="long-data">' + agency_text +
                            '<input name="Rating[' + rowindex + '].agency_code" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.agency_name" textvalue="' + agency_text + '" ' +
                            'valuefield="RatingRightModal.agency_code" value="' + agency_val + '">' +
                            '<input name="Rating[' + rowindex + '].agency_name" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.agency_name" textvalue="' + agency_text + '" ' +
                            'valuefield="RatingRightModal.agency_code" value="' + agency_val + '">' +
                            '</td >');

                        var ColShortLongTerm = $('<td class="long-data">' + short_long_term_text +
                            '<input name="Rating[' + rowindex + '].short_long_term" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.short_long_term_text" textvalue="' + short_long_term_text + '" ' +
                            'valuefield="RatingRightModal.short_long_term" value="' + short_long_term_val + '">' +
                            '<input name="Rating[' + rowindex + '].short_long_term_text" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.short_long_term_text" textvalue="' + short_long_term_text + '" ' +
                            'valuefield="RatingRightModal.short_long_term" value="' + short_long_term_val + '">' +
                            '</td > ');

                        var ColLocalRating = $('<td class="long-data">' + local_rating_text +
                            '<input name="Rating[' + rowindex + '].local_rating" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.local_rating_text" textvalue="' + local_rating_text + '" ' +
                            'valuefield="RatingRightModal.local_rating" value="' + local_rating_val + '">' +
                            '<input name="Rating[' + rowindex + '].local_rating_text" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.local_rating_text" textvalue="' + local_rating_text + '" ' +
                            'valuefield="RatingRightModal.local_rating" value="' + local_rating_val + '">' +
                            '</td>');

                        var ColForeignRating = $('<td class="long-data">' + foreign_rating_text +
                            '<input name="Rating[' + rowindex + '].foreign_rating" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.foreign_rating_text" textvalue="' + foreign_rating_text + '" ' +
                            'valuefield="RatingRightModal.foreign_rating" value="' + foreign_rating_val + '">' +
                            '<input name="Rating[' + rowindex + '].foreign_rating_text" type="hidden" Isdropdown="true" ' +
                            'textfield="RatingRightModal.foreign_rating_text" textvalue="' + foreign_rating_text + '" ' +
                            'valuefield="RatingRightModal.foreign_rating" value="' + foreign_rating_val + '">' +
                            '</td > ');

                        var ColRowStatus = $('<td><input name="Rating[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="create"></td>');

                        var ColAction = $('<td class="action">' +
                            '<button class="btn btn-default btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="update" onclick="GM.Counterparty.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="delete" onclick="GM.Counterparty.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                            '</button>' +
                            '</td>');
                ...
                case 'update':
                    ...
                    if (!GM.Counterparty.Rating.Table.RowAny(agency_val, null, rowindex)) {
                        ...
                        ColRowStatus.html('<input name="Rating[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="' + textstatus + '">');

                        ColAction.html('<button class="btn btn-default btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="update" onclick="GM.Counterparty.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="delete" onclick="GM.Counterparty.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                ...
                case 'delete':
                    ...
                    if (checkrow == 0) {
                        ...
                        row.append(rowEmpty);
                        GM.Counterparty.Rating.Table.append(row);
                        //GM.Counterparty.Rating.Table.attr("style", "display: none");
                    }
        ...
        if (isValid) {
            switch (action) {
                case 'create':
                    ...
                    var rowindex = GM.Counterparty.Haircut.Table.find("tbody tr:last").data("id");
                    ...
                    if (!GM.Counterparty.Haircut.Table.RowAny(cur, formula)) {
                        ...
                        if (rowindex !== 0)
                            rowindex = GM.Counterparty.Haircut.Table.find("tbody tr").length;
                ...
                case 'delete':
                    ...
                    if (checkrow == 0) {
                        ...
                        row.append(rowEmpty);
                        GM.Counterparty.Haircut.Table.append(row);
                        //GM.Counterparty.Haircut.Table.attr("style", "display: none");
                    }
                    break;
            }
    ...
    GM.Counterparty.Exchange.Table.RowAny = function (code, code2, rowid) {
        ...
        if (isValid) {
            ...
            switch (action) {
                case 'create':
                    ...
                    var rowindex = GM.Counterparty.Exchange.Table.find("tbody tr:last").data("id");
                    if (!GM.Counterparty.Exchange.Table.RowAny(cur)) {
                        ...
                        if (rowindex !== 0)
                            rowindex = GM.Counterparty.Exchange.Table.find("tbody tr").length;

                        var ColCur = $('<td class="long-data">' + cur_name +
                            '<input name="Exchange[' + rowindex + '].cur" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.cur_name" textvalue="' + cur_name + '" ' +
                            'valuefield="ExchangeRightModel.cur" value="' + cur + '">' +

                            '<input name="Exchange[' + rowindex + '].cur_name" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.cur_name" textvalue="' + cur_name + '" ' +
                            'valuefield="ExchangeRightModel.cur" value="' + cur + '">' +
                            '</td >');

                        var ColFormula = $('<td class="long-data">' + source_type_name +
                            '<input name="Exchange[' + rowindex + '].source_type" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.source_type_name" textvalue="' + source_type_name + '" ' +
                            'valuefield="ExchangeRightModel.source_type" value="' + source_type + '">' +

                            '<input name="Exchange[' + rowindex + '].source_type_name" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.source_type_name" textvalue="' + source_type_name + '" ' +
                            'valuefield="ExchangeRightModel.source_type" value="' + source_type_name + '">' +
                            '</td > ');

                        var ColCalculateType = $('<td class="long-data">' + exchange_type_name +
                            '<input name="Exchange[' + rowindex + '].exchange_type" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.exchange_type_name" textvalue="' + exchange_type_name + '" ' +
                            'valuefield="ExchangeRightModel.exchange_type" value="' + exchange_type + '">' +

                            '<input name="Exchange[' + rowindex + '].exchange_type_name" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.exchange_type_name" textvalue="' + exchange_type_name + '" ' +
                            'valuefield="ExchangeRightModel.exchange_type" value="' + exchange_type_name + '">' +
                            '</td>');

                        var ColRowStatus = $('<td><input name="Exchange[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="create"></td>');

                        var ColAction = $('<td class="action">' +
                            '<button class="btn btn-default btn-round icon-only" type="button" data-id="' + cur + '" data-action="update" onclick="GM.Counterparty.Exchange.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + cur + '" data-action="delete" onclick="GM.Counterparty.Exchange.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                            '</button>' +
                            '</td>');
                ...
                case 'update':
                    //#region update
                    GM.Counterparty.Exchange.Table.attr("style", "display: show");
                    var row = GM.Counterparty.Exchange.Table.RowSelected;
                    var rowindex = row.data("id");
                    var rowfrom = row.data("action");
                    var textstatus = "create";
                    if (rowfrom == "fromdatabase") {
                    ...
                    if (!GM.Counterparty.Exchange.Table.RowAny(cur, null, rowindex)) {
                        ...
                        ColCur.html(cur_name + '<input name="Exchange[' + rowindex + '].cur" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.cur_name" textvalue="' + cur_name + '" ' +
                            'valuefield="ExchangeRightModel.cur" value="' + cur + '">' +
                            '<input name="Exchange[' + rowindex + '].cur_name" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.cur_name" textvalue="' + cur_name + '" ' +
                        ...
                        ColFormula.html(source_type_name + '<input name="Exchange[' + rowindex + '].source_type" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.source_type_name" textvalue="' + source_type_name + '" ' +
                            'valuefield="ExchangeRightModel.source_type" value="' + source_type + '">' +
                        ...
                        ColCalculateType.html(exchange_type_name + '<input name="Exchange[' + rowindex + '].exchange_type" type="hidden" Isdropdown="true" ' +
                            'textfield="ExchangeRightModel.exchange_type_name" textvalue="' + exchange_type_name + '" ' +
                            'valuefield="ExchangeRightModel.exchange_type" value="' + exchange_type + '">' +
                        ...
                        ColRowStatus.html('<input name="Exchange[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="update">');

                        ColAction.html('<button class="btn btn-default btn-round icon-only" type="button" data-id="' + cur + '" data-action="update" onclick="GM.Counterparty.Exchange.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + cur + '" data-action="delete" onclick="GM.Counterparty.Exchange.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                ...
                case 'delete':
                    ...
                    if (checkrow == 0) {
                        ...
                        row.append(rowEmpty);
                        GM.Counterparty.Exchange.Table.append(row);
                        //GM.Counterparty.Exchange.Table.attr("style", "display: none");
                    }
                    break;
                //#endregion                 
            }
    ...
    //$('#btn-form-submit,#btn-nav-form-submit').click(function (event) {
    //    event.preventDefault(); //prevent default action 
    //    $('form')[0].submit();
    //});
