        ...
        switch (action) {
            ...
            case 'delete':
                ...
                if (checkrow == 0) {
                    ...
                    row.append(rowEmpty);
                    GM.Issuer.Identify.Table.append(row);
                    //GM.Issuer.Identify.Table.attr("style", "display: none");
                }
            ...
            switch (action) {
                case 'create':
                    ...
                    if (!GM.Issuer.Rating.Table.RowAny(agency_val)) {
                        ...
                        var ColAgencyCode = $('<td class="long-data">' + agency_text +
                            ...
                            'textfield="RatingRightModal.agency_name" textvalue="' + agency_text + '" ' +
                            'valuefield="RatingRightModal.agency_code" value="' + agency_text + '">' +
                            '</td >');
                        ...
                        var ColShortLongTerm = $('<td class="long-data">' + short_long_term_text +
                            ...
                            'textfield="RatingRightModal.short_long_term_text" textvalue="' + short_long_term_text + '" ' +
                            'valuefield="RatingRightModal.short_long_term" value="' + short_long_term_text + '">' +
                            '</td > ');
                        ...
                        var ColLocalRating = $('<td class="long-data">' + local_rating_text +
                            ...
                            'textfield="RatingRightModal.local_rating_text" textvalue="' + local_rating_text + '" ' +
                            'valuefield="RatingRightModal.local_rating" value="' + local_rating_text + '">' +
                            '</td>');
                        ...
                        var ColForeignRating = $('<td class="long-data">' + foreign_rating_text +
                            ...
                            'textfield="RatingRightModal.foreign_rating_text" textvalue="' + foreign_rating_text + '" ' +
                            'valuefield="RatingRightModal.foreign_rating" value="' + foreign_rating_text + '">' +
                            '</td > ');

                        var ColRowStatus = $('<td><input name="Rating[' + rowindex + '].rowstatus" Isdropdown="false"  type="hidden" value="create"></td>');

                        var ColAction = $('<td class="action">' +
                            '<button class="btn btn-default btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="update" onclick="GM.Issuer.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="delete" onclick="GM.Issuer.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                            '</button>' +
                            '</td>');
                ...
                case 'update':
                    ...
                    if (!GM.Issuer.Rating.Table.RowAny(agency_val, null, rowindex)) {
                        ...
                        ColAction.html('<button class="btn btn-default btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="update" onclick="GM.Issuer.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-edit"></i>' +
                            '</button > ' +
                            '<button class="btn btn-delete btn-round icon-only" type="button" data-id="' + agency_val + '" data-action="delete" onclick="GM.Issuer.Rating.Form.Show(this)" >' +
                            '<i class="feather-icon icon-trash-2"></i>' +
                ...
                case 'delete':
                    ...
                    var rowselect = GM.Issuer.Rating.Table.RowSelected;
                    var rowfrom = rowselect.data("action");
                    var rowid = rowselect.data("id");
                    if (rowfrom != "fromdatabase") {
